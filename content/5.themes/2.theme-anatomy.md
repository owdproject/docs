...
import { registerThemeTailwindPath } from '@owdproject/kit-primevue/kit/registerThemeTailwindPath'
...
Call **`registerThemeTailwindPath`** once in theme setup, and call **`registerTailwindPath`** (both imported from `@owdproject/kit-primevue/kit/registerTailwindPath`) for any custom paths containing Tailwind classes.
