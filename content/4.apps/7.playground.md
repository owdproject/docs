...
Add **`playground/app/plugins/launch-<slug>.client.ts`** to open your app on boot in dev. Requires:

- **`dependsOn: ['owd-<slug>-register']`** matching your register plugin name.
