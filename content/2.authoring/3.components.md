...
description: MDC components for structuring OWD docs (Nuxt UI prose).
navigation:
...
**Prose** components and MDC blocks here come from the Docus layer + **Nuxt UI**. When docs run *inside* the OWD desktop, you can reuse the same content files; visual chrome will follow the active theme.
::
