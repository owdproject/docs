...
description: Text, titles, and styling for OWD docs (Nuxt Content / MDC).
navigation:
  icon: i-lucide-heading-1
---

::callout{icon="i-lucide-info"}
Examples below follow the **Docus** theme for this site. The same Markdown and [MDC](https://content.nuxt.com/docs/files/markdown#mdc-syntax) conventions will apply when content is embedded in the OWD desktop.
::
